 ...
 * 2015/10/20
 */
public class RecyclerViewLoadMoreContainer extends RecyclerViewRefreshContainerBase
...
//                        lastVisibleItemPosition = findMax(lastPositions);
    ...
    public RecyclerViewLoadMoreContainer(Context context) {
        super(context);
    }

    public RecyclerViewLoadMoreContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RecyclerViewLoadMoreContainer(Context context, AttributeSet attrs, int defStyleAttr) {
