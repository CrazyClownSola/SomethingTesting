 ...
 * 2015/10/16
 */
public abstract class RecyclerViewRefreshContainerBase extends ViewGroup {
    ...
    public RecyclerViewRefreshContainerBase(Context context) {
        super(context);
    }

    public RecyclerViewRefreshContainerBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RecyclerViewRefreshContainerBase(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        if (childCount > 2)
            throw new IllegalStateException("Pull to Refresh Container only can hold 3 elements");
